			...
			<div class="wrap-login100">
				...
				<form action="loginproc.php" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input class="input100" type="password" name="password" placeholder="Password" id="password" minlength="8" required title="password should be atleast 8characters" required>
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
