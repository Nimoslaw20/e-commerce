			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h3>Thank you for purchasing <?php echo"".$_SESSION['user_name']."";
									 ?>, Your order is complete</h3><br><br>
						<table style='width:100%'>
							  <tr>
							    <th>Quantity x Product Name</th>
							    <th>Price</th>
						...
						<?php
					        ...
					        //run the function to return all product and assign to variable
								...
								if ($prodetails) 
								{
									...
									echo"<td><b>".$prodqty." x ".$ptitle."</b></td>";
									echo"<td><b>".$protatal."</td>";
						...
						delete_all_cart_fxn($cid);
						?>
					</table>
					<h2><p><span><b>Subtotal:</b></span> <span><b><?php 
                                			echo $total ;?></b></span></p></h2>
						<br><br>
						...
						<?php
					         	...
					         	$cid=$_SESSION['user_id'];
					         	$status='paid';
					         	$revised_status='Deliver';
					         	$orderlist = view_order_details($cid,$status);
								if ($orderlist) {
						...
						update_status($revised_status,$cid);
						?>
						</table>
						<br><br>
						<p>
